 ...
 * Includes grouping, display names, formatting rules, and default visibility
 */

const CSI300ColumnManifest = {
    version: '1.0.0',
    lastUpdated: '2025-10-09',
    
    // Column groups for organized selection
    groups: [
        {
            id: 'basics',
    ...
    presetViews: [
        ...
        },
        {
            ...
            isSystem: true,
            columns: ['ticker', 'name', 'im_sector', 'pe_ratio_trailing', 'pe_ratio_consensus', 'peg_ratio', 'market_cap_usd', 'price_local_currency'],
            pinnedColumns: ['ticker', 'name']
        },
        {
            id: 'profitability',
            ...
            isSystem: true,
            columns: ['ticker', 'name', 'im_sector', 'roe_trailing', 'roa_trailing', 'operating_margin_trailing', 'operating_profits_per_share', 'net_profits_fy0'],
            pinnedColumns: ['ticker', 'name']
        },
        {
            id: 'risk',
            ...
            isSystem: true,
            columns: ['ticker', 'name', 'im_sector', 'debt_to_equity', 'debt_to_total_assets', 'interest_coverage_ratio', 'current_ratio', 'quick_ratio'],
            pinnedColumns: ['ticker', 'name']
        },
        {
            id: 'earnings',
            ...
            isSystem: true,
            columns: ['ticker', 'name', 'im_sector', 'eps_trailing', 'eps_actual_fy0', 'eps_forecast_fy1', 'eps_growth_percent', 'pe_ratio_trailing'],
            pinnedColumns: ['ticker', 'name']
        },
        {
            id: 'dividends',
            ...
            isSystem: true,
            columns: ['ticker', 'name', 'im_sector', 'dividend_yield_fy0', 'dividend_payout_ratio', 'dividend_local_currency', 'dividend_3yr_cagr', 'dividend_5yr_cagr'],
            pinnedColumns: ['ticker', 'name']
        },
        {
            id: 'financial_health',
            ...
            isSystem: true,
            columns: ['ticker', 'name', 'total_assets_local', 'total_debt_local', 'ebitda_fy0', 'cash_flow_operations_fy0', 'current_ratio', 'debt_to_equity'],
            pinnedColumns: ['ticker', 'name']
        }
    ],
...
if (typeof window !== 'undefined') {
    window.CSI300ColumnManifest = CSI300ColumnManifest;
}

// Export for use in other modules (Node.js)
if (typeof module !== 'undefined' && module.exports) {
    module.exports = CSI300ColumnManifest;
}
