    ...
    def to_representation(self, instance):
        ...
        if isinstance(instance, dict):
            ...
            data = {
                ...
                'formatted_date': instance.formatted_date if hasattr(instance, 'formatted_date') else None,
                ...
                'last_updated': instance.updated_at.isoformat() if hasattr(instance, 'updated_at') and instance.updated_at else None
            }
