...
class ModalContent(models.Model):
    ...
    importance = models.TextField(verbose_name="Importance",
                                help_text="Explanation of why this indicator/content is important")
    source = models.CharField(max_length=500, verbose_name="Data Source",
                            help_text="Source of the data")
    
    # Structured data fields
    breakdown_data = models.JSONField(null=True, blank=True,
    ...
    # Status and metadata
    is_active = models.BooleanField(default=True, verbose_name="Is Active",
                                   help_text="Whether to display in frontend")
    ...
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True,
                                  ...
                                  verbose_name="Created By", blank=True)
    updated_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True,
                                  related_name='updated_contents',
                                  verbose_name="Updated By", blank=True)
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Created At")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated At")
