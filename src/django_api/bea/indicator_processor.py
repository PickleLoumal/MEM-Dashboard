...
class BeaIndicatorProcessor:
    ...
    def process_all_indicators(cls):
        ...
        try:
            ...
            for series_id, config in all_configs.items():
                try:
                    indicator_response = cls.process_indicator_data(
                        series_id, include_quarterly=False
                    )
            ...
            return {"success": False, "error": str(e), "data": {}, "indicators_count": 0}
        ...
        try:
            ...
            for series_id, config in category_configs.items():
                try:
                    ...
                    logger.exception(
                        "Error processing indicator {series_id} in category {category}"
                    )
                    continue
    ...
    def get_available_indicators(cls):
        ...
        try:
            ...
            logger.exception("Error getting available indicators")
...
class BeaCompatibilityProcessor:
    ...
    def get_motor_vehicles_data(cls):
        ...
        return BeaIndicatorProcessor.process_indicator_data(
            "MOTOR_VEHICLES", include_quarterly=True
        )
    ...
    def get_recreational_goods_data(cls):
        ...
        return BeaIndicatorProcessor.process_indicator_data(
            "RECREATIONAL_GOODS", include_quarterly=False
        )
    ...
    def get_bea_status(cls):
        ...
        try:
            ...
            logger.exception("Error getting BEA status")
            return {
                "success": False,
                "error": str(e),
                "service": "BEA Django API",
