...
class DynamicFredUsConfigManager:
    ...
    def get_all_indicators(cls):
        ...
        try:
            ...
            logger.error(f"Error loading FRED US configs from database: {e}")
    ...
    def get_auto_fetch_indicators(cls):
        ...
        try:
            ...
            logger.error(f"Error loading auto-fetch configs: {e}")
            return {}
    ...
    def get_indicator_config(cls, series_id):
        ...
        try:
            ...
            logger.error(f"Error loading config for {series_id}: {e}")
            return None
    ...
    def get_configs_by_category(cls, category):
        ...
        try:
            ...
            logger.error(f"Error loading configs for category {category}: {e}")
            return {}
    ...
    def get_configs_by_frequency(cls, frequency):
        ...
        try:
            ...
            logger.error(f"Error loading configs for frequency {frequency}: {e}")
            return {}
    ...
    def create_indicator(cls, config_data):
        ...
        try:
            ...
            logger.error(f"Error creating FRED US indicator config: {e}")
            raise
    ...
    def update_indicator(cls, series_id, config_data):
        ...
        try:
            ...
            logger.error(f"FRED US indicator config not found: {series_id}")
            return None
        except Exception as e:
            logger.error(f"Error updating FRED US indicator config {series_id}: {e}")
            raise
    ...
    def get_statistics(cls):
        ...
        try:
            ...
            categories = FredUsIndicatorConfig.objects.filter(
                is_active=True
            ).values_list('category', flat=True).distinct()
            
            frequencies = FredUsIndicatorConfig.objects.filter(
                is_active=True,
                auto_fetch=True
            ).values_list('fetch_frequency', flat=True).distinct()
            ...
            logger.error(f"Error getting FRED US statistics: {e}")
            return {}
    ...
    def clear_all_cache(cls):
        ...
        try:
            ...
            all_categories = FredUsIndicatorConfig.objects.values_list('category', flat=True).distinct()
            all_frequencies = FredUsIndicatorConfig.objects.values_list('fetch_frequency', flat=True).distinct()
            ...
            logger.error(f"Error clearing all FRED US cache: {e}")
