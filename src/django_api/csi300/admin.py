...
class CSI300CompanyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Price Information', {
            'fields': (
                'price_local_currency', 'previous_close', 'currency', 
                'last_trade_date', 'price_52w_high', 'price_52w_low',
                'total_return_2018_to_2025'
            )
        }),
        ('Market Cap & Revenue', {
            'fields': (
                'market_cap_local', 'market_cap_usd', 
        ...
        ('Profitability', {
            'fields': (
                ...
                'roa_trailing', 'roe_trailing', 'operating_leverage'
            )
        }),
        ('Earnings Per Share', {
        ...
        ('Debt & Interest', {
            'fields': (
                'interest_expense_fy0', 'effective_interest_rate', 'interest_coverage_ratio',
                'debt_to_total_assets', 'debt_to_equity'
            )
        }),
        ('Liquidity Ratios', {
